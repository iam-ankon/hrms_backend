...
# def send_notification_email(employee_email, message):
#     try:
#         send_mail(
#             'Attendance Delay Alert',
#             message,
#             'ar7web47@gmail.com',
#             [employee_email],
...
#         subject = f"Attendance Delay Notification for {instance.name}"
